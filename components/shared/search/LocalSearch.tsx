...
const LocalSearch = ({
  ...
  placeholder,
  otherClasses,
}: LocalSearchPropsType) => {
  return (
    <div
      className={`.background-light800_darkgradient dark:!dark-gradient flex min-h-[56px] grow items-center gap-4 rounded-[10px] px-4 ${otherClasses}`}
    >
      {iconPosition === "left" && (
        <Image
          src={imgSrc}
